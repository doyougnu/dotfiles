...
(doom! :input
       ...
       (lookup +offline +docsets +dictionary)                   ; navigate your code and its documentation
       (lsp +peek)         ; M-x vscode
       ...
       (haskell +tree-sitter +dante)    ; a language that's lazier than I am
       ...
       (org +pretty +roam2 +tree-sitter +pomodoro)    ; organize your plain life in plain text
       ...
       ;;scala             ; java, but good
       ;; (scheme +tree-sitter +gauche +chez)   ; a fully conniving family of lisps
